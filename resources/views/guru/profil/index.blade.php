...
<div class="p-0 md:p-6 bg-[#f1f5f9] min-h-screen font-sans" x-data="{ photoModal: false }">
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-[1rem] shadow-sm border border-gray-200 overflow-hidden">
            ...
            {{-- Header Profil Guru (KARTU BIRU dengan Pattern) --}}
            <div class="bg-[#004aad] pt-16 pb-12 text-center relative overflow-hidden group">
                {{-- SVG Pattern Tipis (Sama dengan Dashboard) --}}
    ...
    {{ $user->guru->mapel->pluck('nama_mapel')->implode(', ') ?: 'Mata Pelajaran' }}
</p>
                </div>
            </div>
            ...
            <div class="p-10 md:p-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="p-5 bg-slate-50 rounded-3xl border border-gray-100 group hover:bg-white hover:border-[#004aad]/20 transition-all">
                        ...
                        <span class="text-sm font-black text-slate-800 uppercase">{{ $user->nama }}</span>
                    </div>
                    ...
                    {{-- Mata Pelajaran --}}
                    <div class="p-5 bg-slate-50 rounded-3xl border border-gray-100 group hover:bg-white hover:border-[#004aad]/20 transition-all">
                        <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1">Spesialisasi Mengajar</span>
                        <span class="text-sm font-black text-slate-800 uppercase">
    {{ $user->guru->mapel->pluck('nama_mapel')->implode(', ') ?: '-' }}
</span>
                    </div>
                    ...
                    <div class="p-5 bg-slate-50 rounded-3xl border border-gray-100 group hover:bg-white hover:border-[#004aad]/20 transition-all">
                        ...
                        <span class="text-sm font-black text-slate-800 uppercase">
                            {{ $user->guru->kelas ? 'Wali Kelas ' . $user->guru->kelas->nama_kelas : 'Bukan Wali Kelas' }}
                        </span>
                    </div>
                ...
                {{-- Masukkan ini di bawah bagian grid "Informasi Dasar" pada file profil tadi --}}
...
<div class="p-5 bg-slate-50 rounded-3xl border border-gray-100 group hover:bg-white hover:border-[#004aad]/20 transition-all">
    ...
    <div class="p-5 bg-slate-50 rounded-3xl border border-gray-100 group hover:bg-white hover:border-[#004aad]/20 transition-all">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('guru.profil.edit') }}#password-section" class="text-[9px] font-black text-[#004aad] uppercase no-underline hover:underline">Ubah Password</a>
        </div>
    </div>
</div>
    ...
    {{-- MODAL LIGHTBOX FOTO (Gaya Modern) --}}
