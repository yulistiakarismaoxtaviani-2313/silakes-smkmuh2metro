...
<div class="flex-1 bg-[#F8FAFC] p-0 md:p-8 overflow-y-auto custom-scrollbar font-sans">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-b-xl shadow-xl border-x border-b border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('admin.mapel.store') }}" method="POST" class="p-10 space-y-8">
                @csrf
                ...
                <div class="relative group">
                    ...
                    <p class="mt-2 text-[10px] text-slate-400 italic"> Pastikan nama mata pelajaran sesuai dengan kurikulum yang berlaku.</p>
                </div>
